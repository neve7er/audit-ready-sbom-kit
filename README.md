...
**Status**: Phase 2 complete — triage engine, time-bounded exceptions, externalized policy
| | |
|---|---|
| License | MIT |
| Node | ≥ 18 |
...
| Time-bounded exceptions | [docs/policy-schema.md](docs/policy-schema.md) |
| `--fail-on` policy enforcement | [docs/architecture.md](docs/architecture.md) |
| SARIF output + GitHub Advanced Security | [docs/sarif-integration.md](docs/sarif-integration.md) |
| Network transparency (only PURLs sent to OSV) | [docs/transparency.md](docs/transparency.md) |
...
All tuning lives in `.audit-policy.json`. See [docs/policy-schema.md](docs/policy-schema.md) for the full schema.
...
| File | Audience |
|---|---|
| [docs/architecture.md](docs/architecture.md) | Architects, CI/CD maintainers |
